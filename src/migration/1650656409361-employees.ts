...
export class employees1650656409361 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "leasing_company_employees" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdDate" TIMESTAMP NOT NULL DEFAULT now(), "updatedDate" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_dfa644892c49bc70bbf44e565a4" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `ALTER TABLE "sales_department" ADD "leasingCompanyEmployeesId" uuid`,
    );
    await queryRunner.query(
      `ALTER TABLE "analitics_department" ADD "leasingCompanyEmployeesId" uuid`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "analitics_department" DROP COLUMN "leasingCompanyEmployeesId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "sales_department" DROP COLUMN "leasingCompanyEmployeesId"`,
    );
